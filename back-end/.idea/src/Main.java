...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        if(password.equals("avioncumotorpa55")){
            ...
            System.out.println("3. Adaugare aeroport");
            System.out.println("4. Afisare aeroporturi");
            System.out.println("5. Adaugare companie aeriana");
            System.out.println("6. Afisare companii aeriene");
                ...
                switch(optiune){
                    ...
                    case 2:
                        if(zborIdentificat == true){
                            Utilitare.afisarePasageri(pasageri, indexPasager);

                        }

                    case 3:
                        Utilitare.adaugareAeroport();
                        break;

                    case 4:
                        Utilitare.afisareAeroporturi();
                        break;

                    case 5:
                        Utilitare.adaugareCompanieAeriana();
                        break;

                    case 6:
                        Utilitare.afisareCompaniiAeriene();
                        break;
                    default:
...
//            }
            ...
            //a passanger can only see his own ticket
            System.out.println("Biletul dumneavoastra este: ");
            Utilitare.afisarePasageri(pasageri, indexPasager);


            System.out.println("Treceti in modul administrator pentru a putea vizualiza toti pasagerii!");
            System.out.println("Introduceti parola: ");
            ...
            if (admin.equals("avioncumotorpa55")) {
                //afisarea pasagerilor
                Utilitare.afisarePasageriAdmin(pasageri);
            }
            else{
