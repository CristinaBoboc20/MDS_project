...
//                System.out.println(plecare+"-"+sosire+"-"+d.getAn());
    ...
    public static void afisarePasageri(ArrayList<Pasager> pasageri, int indexPasager)
    {
        //a passenger can only see his own ticket
        System.out.println("Pasagerul cu indexul " + indexPasager + " are urmatoarele bilete:");
        for (int i = 0; i < pasageri.size(); i++)
        {
            if (pasageri.get(i).getId() == indexPasager)
            {
    ...
    public static void afisarePasageriAdmin(ArrayList<Pasager> pasageri)
    {
        //admin can see all tickets
        System.out.println("Toate biletele sunt:");
        for (int i = 0; i < pasageri.size(); i++)
        {
            pasageri.get(i).afiseaza();
        }
    ...
    public static void adaugareAeroport(){

        Scanner aeroport = new Scanner(System.in);
        System.out.println("Introduceti numele aeroportului:");
        String numeAeroport = aeroport.nextLine();

        //verificam daca aeroportul exista deja
        //check the C:\Users\Andrei\Desktop\ProiectJava\Aeroporturi.in file

        try {
            File file = new File("C:\\Users\\Andrei\\Desktop\\ProiectJava\\Aeroporturi.in");
            Scanner scanner = new Scanner(file);
            while (scanner.hasNextLine()) {
                String line = scanner.nextLine();
                if (line.equals(numeAeroport)) {
                    System.out.println("Aeroportul exista deja!");
                    //wait for user to press enter
                    System.out.println("Apasati ENTER pentru a incerca din nou!");
                    ...
                    try {
                        FileWriter myWriter = new FileWriter("C:\\Users\\Andrei\\Desktop\\ProiectJava\\Aeroporturi.in", true);
                        myWriter.write( '\n' + numeAeroport + " ");
                        myWriter.close();
                        System.out.println("Aeroportul a fost adaugat cu succes!");
                        //wait for user to press enter
    ...
    public static void afisareAeroporturi(){
        try {
            int i = 0;
            File file = new File("C:\\Users\\Andrei\\Desktop\\ProiectJava\\Aeroporturi.in");
            Scanner scanner = new Scanner(file);
    ...
    public static void adaugareCompanieAeriana(){

        Scanner companie = new Scanner(System.in);
        System.out.println("Introduceti numele companiei:");
        String numeCompanie = companie.nextLine();

        //verificam daca aeroportul exista deja
        //check the C:\Users\Andrei\Desktop\ProiectJava\CompaniiAerience.in file

        try {
            File file = new File("C:\\Users\\Andrei\\Desktop\\ProiectJava\\CompaniiAeriene.in");
            Scanner scanner = new Scanner(file);
            while (scanner.hasNextLine()) {
                String line = scanner.nextLine();
                if (line.equals(numeCompanie)) {
                    System.out.println("Compania exista deja!");
                    //wait for user to press enter
                    System.out.println("Apasati ENTER pentru a incerca din nou!");
                    Scanner scanner1 = new Scanner(System.in);
                    scanner1.nextLine();
                    ...
                    try {
                        FileWriter myWriter = new FileWriter("C:\\Users\\Andrei\\Desktop\\ProiectJava\\CompaniiAeriene.in", true);
                        myWriter.write( '\n' + numeCompanie + " ");
                        myWriter.close();
                        System.out.println("Compania a fost adaugat cu succes!");
                        //wait for user to press enter
                        System.out.println("Apasati ENTER pentru a continua!");
                        Scanner scanner1 = new Scanner(System.in);
                        scanner1.nextLine();
    ...
    public static void afisareCompaniiAeriene(){
        try {
            int i = 0;
            File file = new File("C:\\Users\\Andrei\\Desktop\\ProiectJava\\CompaniiAeriene.in");
            Scanner scanner = new Scanner(file);
